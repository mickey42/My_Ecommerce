...
// Returns the private 'App\Repository\SolutionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SolutionRepository.php';

return $this->privates['App\\Repository\\SolutionRepository'] = new \App\Repository\SolutionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
