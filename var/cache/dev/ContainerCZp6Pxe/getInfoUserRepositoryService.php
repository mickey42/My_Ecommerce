...
// Returns the private 'App\Repository\InfoUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InfoUserRepository.php';

return $this->privates['App\\Repository\\InfoUserRepository'] = new \App\Repository\InfoUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
