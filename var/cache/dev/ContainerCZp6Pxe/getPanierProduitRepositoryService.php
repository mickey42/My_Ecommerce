...
// Returns the private 'App\Repository\PanierProduitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PanierProduitRepository.php';

return $this->privates['App\\Repository\\PanierProduitRepository'] = new \App\Repository\PanierProduitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
