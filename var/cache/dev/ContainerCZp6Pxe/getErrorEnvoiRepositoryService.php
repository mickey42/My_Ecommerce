...
// Returns the private 'App\Repository\ErrorEnvoiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ErrorEnvoiRepository.php';

return $this->privates['App\\Repository\\ErrorEnvoiRepository'] = new \App\Repository\ErrorEnvoiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
