...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\EcommerceController' => 'getEcommerceControllerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-G7KBis50o', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VydpcD2HNi', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AchatRepository' => ['privates', 'App\\Repository\\AchatRepository', 'getAchatRepositoryService.php', true],
            'App\\Repository\\AvisRepository' => ['privates', 'App\\Repository\\AvisRepository', 'getAvisRepositoryService.php', true],
            'App\\Repository\\CBRepository' => ['privates', 'App\\Repository\\CBRepository', 'getCBRepositoryService.php', true],
            'App\\Repository\\ErrorEnvoiRepository' => ['privates', 'App\\Repository\\ErrorEnvoiRepository', 'getErrorEnvoiRepositoryService.php', true],
            'App\\Repository\\InfoUserRepository' => ['privates', 'App\\Repository\\InfoUserRepository', 'getInfoUserRepositoryService.php', true],
            'App\\Repository\\MessageRepository' => ['privates', 'App\\Repository\\MessageRepository', 'getMessageRepositoryService.php', true],
            'App\\Repository\\PanierProduitRepository' => ['privates', 'App\\Repository\\PanierProduitRepository', 'getPanierProduitRepositoryService.php', true],
            'App\\Repository\\PanierRepository' => ['privates', 'App\\Repository\\PanierRepository', 'getPanierRepositoryService.php', true],
            'App\\Repository\\ProduitRepository' => ['privates', 'App\\Repository\\ProduitRepository', 'getProduitRepositoryService.php', true],
            'App\\Repository\\PromoRepository' => ['privates', 'App\\Repository\\PromoRepository', 'getPromoRepositoryService.php', true],
            'App\\Repository\\SavRepository' => ['privates', 'App\\Repository\\SavRepository', 'getSavRepositoryService.php', true],
            ...
            'App\\Repository\\CBRepository' => '?',
            'App\\Repository\\ErrorEnvoiRepository' => '?',
            'App\\Repository\\InfoUserRepository' => '?',
            'App\\Repository\\MessageRepository' => '?',
            'App\\Repository\\PanierProduitRepository' => '?',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_70d8e7d4783ae534e505e31d6d6f0e9d0967285b9f3cdb145b813dff1c9b4f78');
    ...
    protected function getTwigService()
    {
        ...
        $h = new \Limenius\ReactRenderer\Context\SymfonyContextProvider($f);
        ...
        $instance->addExtension(new \Limenius\ReactRenderer\Twig\ReactRenderExtension(new \Limenius\ReactRenderer\Renderer\PhpExecJsReactRenderer(($this->targetDirs[3].'/src/Resources/webpack/server-bundle.js'), false, $h, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService())), new \Limenius\ReactRenderer\Renderer\StaticReactRenderer(), $h, 'both', false));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LldwjdKgBo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1c7vNvb4ZI', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JFKl-bbUaR', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tOel-GBmGc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EOZ5lEU3-k', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fMzhB7NMOg', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aDwV9x-Ljy', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dHx6cUzSW1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
