...
// Returns the private 'App\Repository\SavRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SavRepository.php';

return $this->privates['App\\Repository\\SavRepository'] = new \App\Repository\SavRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
