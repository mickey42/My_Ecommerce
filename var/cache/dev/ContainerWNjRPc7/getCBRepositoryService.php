...
// Returns the private 'App\Repository\CBRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CBRepository.php';

return $this->privates['App\\Repository\\CBRepository'] = new \App\Repository\CBRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
