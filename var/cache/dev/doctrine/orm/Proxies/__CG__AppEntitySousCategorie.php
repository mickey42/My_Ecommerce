...
class SousCategorie extends \App\Entity\SousCategorie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\SousCategorie' . "\0" . 'id', '' . "\0" . 'App\\Entity\\SousCategorie' . "\0" . 'categorieId', '' . "\0" . 'App\\Entity\\SousCategorie' . "\0" . 'name', '' . "\0" . 'App\\Entity\\SousCategorie' . "\0" . 'produits'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCategorieId(int $categorieId): \App\Entity\SousCategorie
    {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\SousCategorie
    {
